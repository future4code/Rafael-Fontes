    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div>
                    <label>Nome:</label>
                    <input value={form.name} name="name" onChange={handleInputChange} type="text" pattern={"(.*[a-z]){3}"} required></input>
                </div>
                <div>
                    <label>Idade:</label>
                ...
                <div>
                    ...
                    <input value={form.profession} name="profession" onChange={handleInputChange} type="text" pattern={"[A-Za-z]{10,}"} required></input>
                </div>
                <div>
                    <label>País:</label>
